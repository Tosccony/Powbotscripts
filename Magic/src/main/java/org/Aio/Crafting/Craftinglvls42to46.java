...
public class Craftinglvls42to46 extends Task {

    public Craftinglvls42to46() {
        super();
        this.name = "Craftinglvls42to46";
    }

    @Override
    public boolean shouldExecute() {
        return Skill.Crafting.realLevel() > 41 && Skill.Crafting.realLevel() < 45
    ...
    public void execute() {
        ...
        if (Pipe.valid() && Glass.valid()) {
            ...
            if (Widgets.component(270,18,38).visible()) {
                Widgets.component(270,18,38).click();
