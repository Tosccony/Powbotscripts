...
public class Miningthird extends Task {

    public Miningthird() {
        super();
        this.name = "Miningthird";
    }
    ...
    public boolean shouldExecute() {
        return Skill.Mining.realLevel() > 30 && Skill.Mining.realLevel() < 42 && Inventory.stream().name("Adamant pickaxe").isNotEmpty();
    }
